  ...
  return (
    <>
      ...
      <div className="z-40 flex h-screen w-screen items-center justify-center">
        <div className="-mt-24 flex h-4/5 w-4/5 rounded-xl bg-slate-200 shadow-lg">
          {/* left */}
          ...
          <div className="flex flex-[0.4] flex-col items-center justify-center">
            <img
              src={posts.image}
              alt=""
              className="-mt-20 mr-4 h-2/3 w-11/12 rounded-lg object-cover"
            />
            {user.id === id && (
              <div className="-mb-28 mt-10 flex items-center p-3">
                ...
                {/* <button className="ml-10 w-32 rounded-md bg-red-500 p-2 hover:bg-red-700 hover:text-white">
                Delete
              </button> */}
              </div>
            )}
